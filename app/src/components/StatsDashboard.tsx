    ...
    return (
        <div className="w-full max-w-5xl mx-auto space-y-6">
            <div className="rounded-2xl border border-[#2E2E2E] bg-[#232323] p-6 shadow-xl">
                ...
                <p className="text-sm text-focus-muted">A snapshot of your progress and notes.</p>
                <div className="mt-6 grid gap-4 md:grid-cols-3">
                    <div className="rounded-xl border border-[#2E2E2E] bg-[#171717] p-4">
                        <p className="text-xs uppercase tracking-wide text-focus-muted">Completion</p>
                        <p className="text-2xl font-semibold text-white">{playlistStats.completionPercent}%</p>
                        <p className="text-xs text-focus-muted">{playlistStats.completedVideos} of {playlistStats.totalVideos} videos</p>
                    </div>
                    <div className="rounded-xl border border-[#2E2E2E] bg-[#171717] p-4">
                        <p className="text-xs uppercase tracking-wide text-focus-muted">Notes</p>
                        <p className="text-2xl font-semibold text-white">{playlistStats.notesCount}</p>
                        <p className="text-xs text-focus-muted">{playlistStats.notesPerVideo} notes per video</p>
                    </div>
                    <div className="rounded-xl border border-[#2E2E2E] bg-[#171717] p-4">
                        <p className="text-xs uppercase tracking-wide text-focus-muted">Playlists</p>
                        <p className="text-2xl font-semibold text-white">{overall.totalPlaylists}</p>
                        <p className="text-xs text-focus-muted">{overall.totalVideos} videos tracked</p>
                    </div>
                </div>
            </div>
            <div className="rounded-2xl border border-[#2E2E2E] bg-[#232323] p-6 shadow-xl">
                ...
                <div className="mt-4 flex items-center justify-between text-sm">
                    <span className="text-focus-muted">Videos completed</span>
                ...
                <div className="mt-3 h-2 w-full rounded-full bg-[#171717]">
                    <div
                        className="h-2 rounded-full bg-focus-primary"
