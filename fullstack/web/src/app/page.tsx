...
export default function LandingPage() {
    return (
        ...
        >
            ...
            <nav className="fixed top-0 w-full z-50 border-b border-vex-border/50 bg-vex-bg/80 backdrop-blur-md">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="hidden sm:flex items-center gap-4">
                        <Link
                            href="https://github.com/sanjeevafk/FocusTube"
                            target="_blank"
                            rel="noreferrer"
            ...
            <main className="grow pt-24 pb-16 px-4 sm:px-6 relative overflow-hidden">
                <div
                ...
                <section className="max-w-6xl mx-auto text-center">
                    ...
                    <h1 className="mt-8 text-5xl sm:text-6xl lg:text-7xl leading-none text-white font-(--font-display)">
                        Build your
                    ...
                    <p className="mt-6 text-base sm:text-lg text-vex-muted max-w-2xl mx-auto leading-relaxed">
                        ...
                        and focus tools. Synced securely across your devices.
                    </p>
                ...
                <section className="max-w-6xl mx-auto mt-16 grid gap-8 lg:grid-cols-[1.1fr_0.9fr] items-center">
                    ...
                    <div className="rounded-3xl border border-vex-border/60 bg-vex-surface/90 p-8">
                        <h3 className="text-lg text-white font-semibold">Cloud-synced by design</h3>
                        <p className="mt-3 text-sm text-vex-muted leading-relaxed">
                            Your notes, progress, and review data are synced securely via your Google account.
                            Access your learning workspace from any device, anytime.
                        </p>
                        <div className="mt-6 rounded-2xl border border-vex-border/50 bg-[#0c0c0c] p-4 text-xs text-vex-muted">
                            Secure login. No ads. No distraction.
                        </div>
                    </div>
                </section>
            </main>
